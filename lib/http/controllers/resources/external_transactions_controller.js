var ExternalTransaction = require('ripple-gateway-data-sequelize').models.externalTransactions;

function index(req, res){
  ExternalTransaction.findAll().complete(function(err, externalTransactions){
    if (err) {
