...
ApiRouter.prototype.bind = function(app){
  ...
  app.get('/v1/payments/failed', apiController.listFailedPayments);
  app.post('/v1/payments/failed/:id/retry', apiController.retryFailedPayment);
  ...
  app.post('/v1/users/:id/activate', apiController.activateUser);
  app.post('/v1/users/:id/deactivate', apiController.deactivateUser);
