...
models.rippleAddresses.hasMany(models.rippleTransactions, { as: 'Payments' });

models.rippleTransactions.belongsTo(models.rippleAddresses, { as: 'ToAddress', foreignKey: 'to_address_id' });
models.rippleTransactions.belongsTo(models.rippleAddresses, { as: 'FromAddress', foreignKey: 'from_address_id' });

models.rippleAddresses.hasMany(models.rippleTransactions,  { as: 'PaymentsTo', foreignKey: 'to_address_id' });
models.rippleAddresses.hasMany(models.rippleTransactions,  { as: 'PaymentsFrom', foreignKey: 'from_address_id' });
