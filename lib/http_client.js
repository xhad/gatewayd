...
module.exports = {
  Gateway: (function(){
    function Client(opts){
      ...
      // this.clientId = opts.clientId; //this.validate(opts, 'clientId', 'isAlphanumeric')
      // this.clientSecret = opts.clientSecret; //this.validate(opts, 'clientSecret', 'isAlphanumeric')
      this.user = opts.user; //this.validate(opts, 'user', 'isAlphanumeric')
      this.secret = opts.secret; //this.validate(opts, 'secret', 'isAlphanumeric')
