...
function clearWithdrawal(withdrawalId, callback) {
  ...
  async.waterfall([
    function(next) {
      lookupWithdrawal(withdrawalId, next);
    },
    function(withdrawal, next) {
      clearWithdrawalIfNotCleared(withdrawal, next);
    }
  ...
  function lookupWithdrawal(id, callback) {
  ...
  function clearWithdrawalIfNotCleared(withdrawal, callback){
